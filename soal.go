...
func main(){
	...
	if ((input1 < input2) && (input1 < input3) && (input1 < input4)) && ((input2 > input1) && (input2 > input3) && (input2 > input4)) {
		...
		hasil2 = input4
		fmt.Print(hasil1, hasil2)
	} else if ((input1 == input2) && (input1 == input3) && (input1 == input4)) && ((input2 == input1) && (input2 == input3) && (input2 == input4)) && ((input3 == input1) && (input3 == input2) && (input3 == input4)) && ((input4 == input1) && (input4 == input3) && (input4 == input2))  {
		hasil1 = input1
		hasil2 = input1
		fmt.Print(hasil1, hasil2)
	}
